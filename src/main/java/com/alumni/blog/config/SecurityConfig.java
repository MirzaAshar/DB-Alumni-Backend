    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/api/auth/**", "/api/auth/login", "/api/auth/register", "/error", "/api/categories/", "/api/user/{userId}/category/{categoryId}/posts", "/api/users/{userID}", "/api/posts/**", "/api/events/**").permitAll() // Allow unauthenticated access to auth endpoints
