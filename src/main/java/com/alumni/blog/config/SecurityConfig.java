    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/api/auth/**", "/error", "/api/categories/", "/api/user/{userId}/category/{categoryId}/posts", "/api/users/{userID}", "/api/posts/**", "/api/events/**", "/api/comments/post/{postId}/user/{userId}/comments","/post/image/**", "/api/jobs/jobPost", "/api/posts/count", "/api/user/{userId}/posts").permitAll() // Allow unauthenticated access to auth endpoints
